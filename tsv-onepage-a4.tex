...
\cvmail{nishgu@iitk.ac.in} % Email address
...
\aboutme{
  \vspace{-2mm}
  \textbf{B. Tech, May 2017* } \\
  CSE, IIT Kanpur  \hfill  {\Large 9.4/10}  \\
  \vspace{2mm}
  \textbf{HSCE (+2), \space April 2013} \\  
  Shivpuri Public School \hfill {\large 93.6\%} \\
  \vspace{2mm}
  \textbf{AISSCE, April 2011} \\
  Tara Sadan School \hfill {\large 9.6/10} \\
}
...
\tool{
  ...
  \subsection{Others} 
  \vspace{-2mm}
  Emacs, Vim, Git, svn, ElasticSearch, \LaTeX, css/scss, SQL, HTML, nix, elisp

}

\tutor{
  \vspace{-3mm}
  Computer Architecture, Computer Networks, Machine
  Learning, Compiler Design, Databases, Randomized algorithms,
  Functional Programming, Programming Languages,
  Software Engineering, Operating Systems, Algorithms I \& II 
}
...
\extra{
  ...
  \item {\large Polling}, \hfill Jul'16-Nov'16\\
    Built a de-centralized polling system using GO for backend and \\
    python-django for frontend with Redis as in-memory database.
  \end{itemize}
...
\vspace{-4mm}\begin{list3} %\itemsep -1pt
...
\begin{twentyshort} % Environment for a short list with no descriptions
  \twentyitemshort{\sbt  ScalaComplier}{\qquad Scala to x86 compiler written in Python.}

  \twentyitemshort{\faGithub
    \href{http://www.github.com/Nishant9/scalaCompiler}{\texttt{Nishant9/scalaCompiler}}}{\qquad
    Implements dynamic scoping, type checking }
  \vspace{1mm}
  \twentyitemshort{}{\qquad and basic type inference.}
  ...
  \twentyitemshort{\faGithub
    ...
    Competitve programming. Uses django with }
  \vspace{1mm}
  \twentyitemshort{}{\qquad bootstrap3 and sqlite for database.}
  
  \twentyitemshort{\sbt  Operating Systems}{\qquad Implemented core System calls,
    Signal  }
  \twentyitemshort{\faicon{bitbucket}\href{https://bitbucket.org/Nishant9/}
    {\texttt{Nishant9/CS330*}}}{\qquad handling, process scheduling and  }
  \vspace{1mm}
  \twentyitemshort{}{\qquad synchronization primitives for NachOS}

  \twentyitemshort{\sbt  Web Platform}{\qquad Various features and Android app for a} 
  \vspace{1mm}
  \twentyitemshort{}{\qquad  social networking platform} 

  \twentyitemshort{\sbt  Image Triangulation}{\qquad Image filter that renders image
    using only }
  \vspace{1mm}
  \twentyitemshort{}{\qquad triangles}
  
  \twentyitemshort{\sbt  News Map}{\qquad Webapp that scrapes news websites, parses}
  \twentyitemshort{}{\qquad news for location and plots it on a map}
  \vspace{-0.4cm}   
