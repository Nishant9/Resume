...
\begin{center}
  ...
  \indent \begin{tabular}{ l @{\hskip 0.15in} l @{\hskip 0.15in} l @{\hskip 0.15in} l @{\hskip 0.15in} l }
            \textbf{Year}  & \textbf{Examination} & \textbf{Institute} & \textbf{CPI/\%} \\
        ...
        \item Qualified \textbf{Regional Mathematical Olympiad}(Rajasthan Region).
        ...
        \vspace{-1mm}\resheading{\textbf{KEY PROJECTS} }\\[\lsep]\vspace{1mm}
